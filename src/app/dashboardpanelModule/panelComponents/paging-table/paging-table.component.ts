...
import { ActionEventArgs, DataStateChangeEventArgs, GridComponent } from '@syncfusion/ej2-angular-grids';
...
export class PagingTableComponent implements OnInit {
  ...
  public timeScale: TimeScaleModel = { interval: 720, slotCount: 1 };
  public workHours: WorkHoursModel = { start: '08:00', end: '18:00' };
  public currentView: any = 'TimelineWeek';
  public group: GroupModel = {
    // enableCompactView: false,
    resources: ['MeetingRoom']
  };
  public resourceDataSource: Record<string, any>[] = [
    { text: 'Room-1', id: 1, color: '#ea7a57', capacity: 20, type: 'Conference' },
    { text: 'Room-2', id: 2, color: '#7fa900', capacity: 7, type: 'Cabin' },
    { text: 'Room-3', id: 3, color: '#5978ee', capacity: 5, type: 'Cabin' },
    { text: 'Room-4', id: 4, color: '#fec200', capacity: 15, type: 'Conference' },
    { text: 'Room-5', id: 5, color: '#df5286', capacity: 25, type: 'Conference' },
    { text: 'Room-6', id: 6, color: '#00bdae', capacity: 10, type: 'Cabin' },
    { text: 'Room-7', id: 7, color: '#865fcf', capacity: 20, type: 'Conference' },
