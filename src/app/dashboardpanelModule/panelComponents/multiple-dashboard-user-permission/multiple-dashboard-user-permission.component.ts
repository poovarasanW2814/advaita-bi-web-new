...
export class MultipleDashboardUserPermissionComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    this.user_id = currentValue.user_id
    this.chartService.getAllUserDashboardPermissionByRoleidUserId(currentValue.role_id, currentValue.user_id).subscribe(
      (res: any) => {
      ...
      (error: any) => {
        ...
        console.log('Error getting user dashboard permissions', error);
  ...
  ngOnInit(): void {
    ...
    // console.log('role info in multiselect dashboards', this.getUserObj)
 ...
 mergeArrays(permissionDetails: any[], dashboardDetails: any[]): any[] {
  ...
  updatePermissionsOld() {
    ...
    let obj = {
      user_dashboard_permission_details_update_dto : this.dashboards
    }
    ...
    this.chartService.updateuserBasedDashboardAccess(this.updateRoleId, obj).subscribe(
      (res : any) =>{
  ...
  submitPermissionsold(){
    ...
    let apiObj = {
      ...
      "user_dashboard_permission_details_dto":  this.dashboards

    }
    console.log('submitPermissions', apiObj)


    this.chartService.createUserBaseDashboardAcess(apiObj).subscribe(
      (res : any) =>{
  ...
  updatePermissions() {
    console.log('updatePermissions db', this.dashboards);
    ...
    const filteredDashboards = this.dashboards.filter(dashboard => {
      ...
      // Only exclude if id is null and all permission flags are false
    ...
    let obj = {
      user_dashboard_permission_details_update_dto: filteredDashboards
    };
  ...
  submitPermissions() {
    ...
    let apiObj = {
      role_id: this.role_id,
      user_id: this.user_id,
      user_dashboard_permission_details_dto: filteredDashboards
    };
